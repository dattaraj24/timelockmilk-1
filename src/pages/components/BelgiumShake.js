...
useEffect( () => {
  ...
  return (
    <div
      key={cardInfo[2].number}
      className="card"
      style={
        cardClicked === cardInfo[2].number && !isMobile
          ? { width: "450px" }
          : {}
      }
    >
      <img className="card-img" src={cardInfo[2].img} alt="cardtypeimg" />
      ...
      <div className="card-row">
        ...
        >
          <div className="card-locking-period">
            {cardInfo[2].lockingPeriod} MONTHS LOCKING PERIOD
          </div>
      ...
      {cardClicked === cardInfo[2].number
        ...
        : <div className="card-column">
            ...
            <button
              ...
              style={{ background: cardInfo[2].color }}
              onClick={() => {
